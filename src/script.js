/**
 * This code is an implementation of Bruno Imbrizi's tutorial
 * https://tympanus.net/codrops/2019/01/17/interactive-particles-with-three-js/
 * https://github.com/brunoimbrizi/interactive-particles
 *
 * Threejs template was used from Bruno Simon
...
import basicVertexShader from "/src/shaders/vertex.glsl";
import basicFragmentShader from "/src/shaders/fragment.glsl";
import { AdditiveBlending } from "three";

//image path
const imgPath = "/images/iguana.png";
...
const debugObject = {};
debugObject.randomness = 7.5;

gui.add(debugObject, "randomness").min(0).max(15).step(0.1); //texture randomness
/**
 * Base
 */
// Canvas
